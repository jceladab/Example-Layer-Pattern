...
import com.mycompany.exampledoggrooming.Persistance.exceptions.NonexistentEntityException;
...
public class PetJpaController implements Serializable {
    ...
    public PetJpaController() {
        emf = Persistence.createEntityManagerFactory("DogGrommingPU");
    }
